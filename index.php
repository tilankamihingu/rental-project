...
<body>
    ...
    <div class="container">
        <div class="navbar">
            <div class="logo">
               <a href="./index.php"><img src="./images/logo.png" width="125" alt=""></a>
            </div>
            <nav>
            <ul id="MenuItems">
        ...
        <div class="row">
            <div class="col-2">
                <h1>Custermize Events<br> As your choise!.</h1>
                <p>Retnal items for you. we supply your flavour. grab your one. our team can help you to custermize your next event as your choise.. Make your day  deliteful</p>
